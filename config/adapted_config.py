...
class Config:
    def __init__(self, args) -> None:
        ...
        self.train_file = args.train_file  # "data/" + self.dataset + "/train.txt"
        self.dev_file = args.dev_file  # "data/" + self.dataset + "/dev.txt"
        self.test_file = args.test_file  # "data/" + self.dataset + "/test.txt"
        self.label2idx = {}
        self.idx2labels = []
        self.char2idx = {}
        self.idx2char = []
        ...
        self.optimizer = "adam"  # args.optimizer.lower()
    ...
    def build_word_idx(
        ...
        :return:
        """
        self.PAD = transformer_tokenizer.pad_token
        self.UNK = transformer_tokenizer.unk_token
        # self.word2idx = {k: v for k, v in transformer_tokenizer.vocab.items()}
        self.word2idx = transformer_tokenizer.vocab
